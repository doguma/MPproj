import { Component } from '@angular/core'; import { IonicPage,
  NavController,
  Loading,
  LoadingController,
  Alert,
  ...
  export class SignupPage { public signupForm:FormGroup;
  ...
  this.signupForm = formBuilder.group({
    ...
    signupUser():void {
      ...
      this.authProvider.signupUser(email, password).then( user => { this.loading.dismiss().then( () => {
